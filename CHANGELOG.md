...
history lives beside each mod and is generated by Release Please from reviewed
...
- Release Please manifest mode with automatic shared-input fan-out, one rolling
  combined release PR, package-local version/changelog files, package-scoped
  draft releases, and resumable independent publication.
...
- Replaced custom release-plan fragments with Conventional Commit PR titles,
  deterministic package-local shared-input markers, and GitHub App-authored
  Release Please tags and drafts.
